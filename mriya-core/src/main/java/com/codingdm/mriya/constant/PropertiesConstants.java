...
public class PropertiesConstants {
    ...
    public static final String MRIYA_NACOS_CONFIG_SERVERADDR =   "mriya.nacos.config.serverAddr";
    public static final String MRIYA_NACOS_CONFIG_NAMESPACE =    "mriya.nacos.config.namespace";
    public static final String MRIYA_NACOS_CONFIG_DATAID =       "mriya.nacos.config.dataId";
    public static final String MRIYA_NACOS_CONFIG_GROUP =        "mriya.nacos.config.group";
