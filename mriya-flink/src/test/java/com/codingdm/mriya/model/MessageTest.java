...
public class MessageTest {
    ...
    public void createMessage(){
        ...
        System.out.println(message.typeIsDdl());
    }
    ...
    public void testTargetTableName(){
        String jsonString = "{\"data\":[{\"id\":\"6\",\"flow_num\":\"6\",\"order_num\":null,\"product_id\":null,\"paid_amount\":null,\"paid_method\":null," +
                "\"buy_counts\":\"0000-00-00\"," +
                "\"create_time\":\"0000-00-00 00:00:00\"}],\"database\":\"manufacturing\",\"es\":1590890167000,\"id\":1,\"isDdl\":false,\"mysqlType\":{\"id\":\"varchar(20)\",\"flow_num\":\"varchar(20)\",\"order_num\":\"varchar(20)\",\"product_id\":\"varchar(20)\",\"paid_amount\":\"varchar(11)\",\"paid_method\":\"int(11)\",\"buy_counts\":\"int(11)\",\"create_time\":\"datetime\"},\"old\":null,\"pkNames\":[\"id\"],\"sql\":\"\",\"sqlType\":{\"id\":12,\"flow_num\":12,\"order_num\":12,\"product_id\":12,\"paid_amount\":12,\"paid_method\":4,\"buy_counts\":4,\"create_time\":93},\"table\":\"flow\",\"ts\":1590892743870,\"type\":\"INSERT\"}";
        Message message = Message.buildMessage(jsonString, "topic_1");
        System.out.println(message.getTargetTable());
        System.out.println(message.getFormatTableTemplate());
