 ...
 **/
@Slf4j
public class AlterTableVisitor extends MySqlASTVisitorAdapter {
...
//    }
    ...
    public boolean visit(MySqlAlterTableChangeColumn x) {
        ...
        System.out.println(x.getNewColumnDefinition().getName());
        System.out.println(x.getNewColumnDefinition().getDataType());
        System.out.println(x.getNewColumnDefinition().getComment());
    ...
    public boolean visit(MySqlAlterTableOption x) {
        System.out.println("MySqlAlterTableOption");
        return true;
    }
    ...
    public boolean visit(MySqlCreateTableStatement x) {
        System.out.println("MySqlCreateTableStatement");
        x.getTableElementList().forEach(c-> {
            SQLColumnDefinition c1 = (SQLColumnDefinition) c;
    ...
    public boolean visit(MySqlAlterTableModifyColumn x) {
        ...
        System.out.println("MySqlAlterTableModifyColumn");
        return true;
    }
